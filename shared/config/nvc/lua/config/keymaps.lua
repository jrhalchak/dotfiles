...
M.setup = function()
  ...
  local which_keymaps = {
    ...
    { "<leader>ni",   ":Neorg index<CR>",                          desc = "Neorg: Index" },
    { "<leader>nI",   ":Neorg inject-metadata<CR>",                desc = "Neorg: Inject metadata" },
    { "<leader>no",   ":OpenTodos<CR>",                            desc = "Neorg: Open outstanding todos" },
    { "<leader>nm",   group = "Mode" },
    { "<leader>nmh",  ":Neorg mode traverse-heading<CR>",          desc = "Neorg: Mode traverse-heading" },
    { "<leader>nmn",  ":Neorg mode norg<CR>",                      desc = "Neorg: Mode norg" },
    { "<leader>nml",  ":Neorg mode traverse-link<CR>",             desc = "Neorg: Mode traverse-link" },
    { "<leader>nj",   group = "Journal" },
    { "<leader>njt",  ":Neorg journal today<CR>",                  desc = "Neorg: Journal today" },
    { "<leader>njn",  ":Neorg journal tomorrow<CR>",               desc = "Neorg: Journal tomorrow" },
    { "<leader>njp",  ":Neorg journal yesterday<CR>",              desc = "Neorg: Journal yesterday" },
    { "<leader>njc",  ":Neorg journal custom<CR>",                 desc = "Neorg: Journal custom (calendar)" },
    { "<leader>njio", ":Neorg journal toc open<CR>",               desc = "Neorg: Journal toc open" },
    { "<leader>njiu", ":Neorg journal toc update<CR>",             desc = "Neorg: Journal toc update" },
    { "<leader>nd",   desc = "Neorg: Insert date (calendar)" },
    { "<leader>nh",   group = "Heading / item" },
    { "<leader>ns",   group = "Search (telescope)" },
    { "<leader>nsl",  ":Telescope neorg find_linkable<CR>",        desc = "Neorg: Find linkable" },
    { "<leader>nsi",  ":Telescope neorg insert_file_link<CR>",     desc = "Neorg: Insert file link" },
    { "<leader>nsf",  ":Telescope neorg find_norg_files<CR>",      desc = "Neorg: Find norg files" },
    { "<leader>nsL",  ":Telescope neorg insert_link<CR>",          desc = "Neorg: Insert link" },
    { "<leader>nsh",  ":Telescope neorg search_headings<CR>",      desc = "Neorg: Search headings" },
    ...
    { "<leader>ne",   ":Neorg export to-file ",                    desc = "Neorg: Export to file" },
    { "<leader>nS",   ":Neorg generate-workspace-summary<CR>",     desc = "Neorg: Workspace summary" },
