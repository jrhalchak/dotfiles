...
local ns = vim.api.nvim_create_namespace("bdiagram_conceal")
...
local function conceal_bdiagram(bufnr, start_row, end_row)
  ...
  vim.api.nvim_buf_clear_namespace(bufnr, ns, start_row, end_row+1)
          ...
          if child:type() == "_segment" then
            ...
            for r = row, end_row_c do
              ...
              for col = 1, #line do
                ...
                if conceal ~= char then
                  vim.api.nvim_buf_set_extmark(bufnr, ns, r, col-1, {
...
return {
  conceal_bdiagram = conceal_bdiagram,
}
